    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="text-sm text-on-surface-variant space-y-4 leading-relaxed">
          <p>These Terms of Service govern your use of Aurum. By creating an account, you agree to these terms.</p>
          ...
          <p>Aurum facilitates ticket purchases. All transactions are between the attendee and the event organizer. Refund policies are set by each organizer.</p>
          ...
          <p>Aurum is not liable for any damages arising from your use of the platform or attendance at events listed on the platform.</p>
